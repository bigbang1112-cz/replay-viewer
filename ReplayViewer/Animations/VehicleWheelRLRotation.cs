...
class VehicleWheelRLRotation : Animation
{
    public override JSObject GetMember(JSObject ghost)
    {
        var wheel = Vehicle.GetObjectByName(ghost, "1RLWheel")?.GetPropertyAsJSObject("rotation")!;
    ...
    {
        return Timeline.CreateKeyframeVec(period, sample.RLWheelRotation, 0, 0);
    }
}
